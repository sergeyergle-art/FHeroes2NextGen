...
namespace
{
    ...
    const char * getBarbarianBuildingDescription( const BuildingType buildingId )
    {
        ...
        case BUILD_WEL2:
            return _( "The Garbage Heap increases monster growth by 50%." );
        default:
            break;
        }
    ...
    const char * getSorceressBuildingDescription( const BuildingType buildingId )
    {
        ...
        case BUILD_WEL2:
            return _( "The Crystal Garden increases monster growth by 50%." );
        default:
            break;
        }
    ...
    const char * getWarlockBuildingDescription( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_SPEC:
            return _( "The Dungeon increases the income of the town by %{count} gold and 1 sulfur per day.\nIncreases monster growth by 25%." );
        case BUILD_WEL2:
            return _( "The Waterfall increases monster growth by 50%." );
        default:
            break;
        }
    ...
    const char * getWizardBuildingDescription( const BuildingType buildingId )
    {
        ...
        case BUILD_WEL2:
            return _( "The Orchard increases monster growth by 50%." );
        default:
            break;
        }
    ...
    const char * getNecromancerBuildingDescription( const BuildingType buildingId )
    {
        ...
        case BUILD_WEL2:
            return _( "The Skull Pile increases monster growth by 50%." );
        default:
            break;
        }
    ...
    const char * getRandomBuildingDescription( const BuildingType buildingId )
    {
        ...
        case BUILD_WEL2:
            return _( "The Horde Building increases monster growth by 50%." );
        default:
            break;
        }
...
namespace fheroes2
{
    ...
    const char * getBuildingDescription( const int race, const BuildingType buildingId )
    {
        ...
        case BUILD_THIEVESGUILD:
            return _(
                "The Thieves' Guild provides information on enemy players and income %{count} gold per day. Thieves' Guilds can also provide scouting information on enemy towns. Additional Guilds provide more information." );
        case BUILD_TAVERN:
            return _( "The Tavern increases morale for troops defending the castle and income %{count} gold per day." );
        case BUILD_SHIPYARD:
            return _( "The Shipyard allows ships to be built." );
        case BUILD_WELL:
            return _( "The Well increases monster growth by 25%." );
        case BUILD_STATUE:
