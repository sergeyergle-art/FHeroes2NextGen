...
namespace
{
    ...
    const std::array<BuildingStats, 86> buildingStats = { { { BUILD_THIEVESGUILD, Race::ALL, { 1500, 5, 0, 5, 0, 0, 0 } },
                                                            { BUILD_TAVERN, Race::ALL, { 1000, 5, 0, 0, 0, 0, 0 } },
                                                            { BUILD_SHIPYARD, Race::ALL, { 3000, 10, 0, 10, 0, 0, 0 } },
                                                            { BUILD_WELL, Race::ALL, { 1500, 0, 0, 0, 0, 0, 0 } },
                                                            { BUILD_STATUE, Race::ALL, { 1500, 5, 0, 5, 0, 2, 2 } },
                                                            { BUILD_LEFTTURRET, Race::ALL, { 3000, 0, 0, 5, 0, 0, 0 } },
                                                            { BUILD_RIGHTTURRET, Race::ALL, { 3000, 0, 0, 5, 0, 0, 0 } },
                                                            { BUILD_MARKETPLACE, Race::ALL, { 1000, 0, 0, 0, 0, 0, 0 } },
                                                            ...
                                                            { BUILD_MAGEGUILD2, Race::ALL, { 2000, 5, 4, 5, 4, 4, 4 } },
                                                            { BUILD_MAGEGUILD3, Race::ALL, { 2000, 5, 6, 5, 6, 6, 6 } },
                                                            { BUILD_MAGEGUILD4, Race::ALL, { 2000, 5, 8, 5, 8, 8, 8 } },
                                                            { BUILD_MAGEGUILD5, Race::ALL, { 2000, 5, 10, 5, 10, 10, 10 } },

                                                            { BUILD_WEL2, Race::KNGT, { 4500, 0, 0, 0, 0, 0, 0 } },
                                                            { BUILD_WEL2, Race::BARB, { 4500, 0, 0, 0, 0, 0, 0 } },
                                                            { BUILD_WEL2, Race::SORC, { 4500, 0, 0, 0, 0, 0, 0 } },
                                                            { BUILD_WEL2, Race::WRLK, { 4500, 0, 0, 0, 0, 0, 0 } },
                                                            { BUILD_WEL2, Race::WZRD, { 4500, 0, 0, 0, 0, 0, 0 } },
                                                            { BUILD_WEL2, Race::NECR, { 4500, 0, 0, 0, 0, 0, 0 } },

                                                            { BUILD_SPEC, Race::KNGT, { 4500, 5, 0, 15, 0, 0, 0 } },
                                                            { BUILD_SPEC, Race::BARB, { 5000, 10, 0, 10, 0, 0, 0 } },
                                                            { BUILD_SPEC, Race::SORC, { 4500, 0, 0, 0, 0, 5, 5 } },
                                                            { BUILD_SPEC, Race::WRLK, { 6000, 10, 5, 10, 0, 0, 0 } },
                                                            { BUILD_SPEC, Race::WZRD, { 4500, 5, 4, 5, 4, 4, 4 } },
                                                            { BUILD_SPEC, Race::NECR, { 4000, 0, 10, 0, 10, 0, 0 } },

                                                            { BUILD_SHRINE, Race::NECR, { 4000, 10, 0, 0, 0, 10, 0 } },

                                                            { DWELLING_MONSTER1, Race::KNGT, { 400, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER2, Race::KNGT, { 1500, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE2, Race::KNGT, { 2000, 5, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER3, Race::KNGT, { 1500, 0, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE3, Race::KNGT, { 2000, 0, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_MONSTER4, Race::KNGT, { 3000, 10, 0, 10, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE4, Race::KNGT, { 3000, 5, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_MONSTER5, Race::KNGT, { 5000, 15, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE5, Race::KNGT, { 5000, 10, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER6, Race::KNGT, { 8000, 20, 0, 10, 0, 15, 0 } },
                                                            { DWELLING_UPGRADE6, Race::KNGT, { 8000, 10, 0, 5, 0, 15, 0 } },

                                                            { DWELLING_MONSTER1, Race::BARB, { 500, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER2, Race::BARB, { 1300, 5, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE2, Race::BARB, { 1700, 5, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER3, Race::BARB, { 2000, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER4, Race::BARB, { 3000, 10, 0, 10, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE4, Race::BARB, { 4000, 5, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_MONSTER5, Race::BARB, { 6000, 5, 0, 15, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE5, Race::BARB, { 4000, 0, 0, 10, 0, 0, 0 } },
                                                            { DWELLING_MONSTER6, Race::BARB, { 9000, 10, 0, 20, 0, 20, 0 } },

                                                            { DWELLING_MONSTER1, Race::SORC, { 700, 5, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER2, Race::SORC, { 1500, 5, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE2, Race::SORC, { 1500, 5, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER3, Race::SORC, { 2000, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE3, Race::SORC, { 2500, 5, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER4, Race::SORC, { 3500, 0, 0, 10, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE4, Race::SORC, { 2500, 0, 5, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER5, Race::SORC, { 5000, 10, 0, 0, 0, 0, 10 } },
                                                            { DWELLING_MONSTER6, Race::SORC, { 14000, 0, 20, 30, 0, 0, 0 } },

                                                            { DWELLING_MONSTER1, Race::WRLK, { 700, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER2, Race::WRLK, { 1500, 5, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_MONSTER3, Race::WRLK, { 3000, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER4, Race::WRLK, { 4000, 0, 0, 0, 0, 0, 10 } },
                                                            { DWELLING_UPGRADE4, Race::WRLK, { 3000, 0, 0, 0, 0, 0, 5 } },
                                                            { DWELLING_MONSTER5, Race::WRLK, { 6000, 0, 0, 0, 10, 0, 0 } },
                                                            { DWELLING_MONSTER6, Race::WRLK, { 20000, 0, 0, 30, 20, 0, 0 } },
                                                            { DWELLING_UPGRADE6, Race::WRLK, { 10000, 0, 0, 5, 10, 0, 0 } },
                                                            { DWELLING_UPGRADE7, Race::WRLK, { 10000, 0, 0, 5, 10, 0, 0 } },

                                                            { DWELLING_MONSTER1, Race::WZRD, { 600, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER2, Race::WZRD, { 1300, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER3, Race::WZRD, { 2000, 5, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE3, Race::WZRD, { 2500, 0, 5, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER4, Race::WZRD, { 4000, 5, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER5, Race::WZRD, { 5500, 5, 3, 5, 3, 3, 3 } },
                                                            { DWELLING_UPGRADE5, Race::WZRD, { 6000, 5, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_MONSTER6, Race::WZRD, { 17500, 5, 0, 5, 0, 0, 20 } },
                                                            { DWELLING_UPGRADE6, Race::WZRD, { 17500, 5, 0, 5, 0, 0, 20 } },

                                                            { DWELLING_MONSTER1, Race::NECR, { 600, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER2, Race::NECR, { 1000, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE2, Race::NECR, { 1500, 0, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_MONSTER3, Race::NECR, { 2000, 0, 0, 10, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE3, Race::NECR, { 2500, 0, 0, 5, 0, 0, 0 } },
                                                            { DWELLING_MONSTER4, Race::NECR, { 4000, 10, 0, 0, 0, 0, 0 } },
                                                            { DWELLING_UPGRADE4, Race::NECR, { 5000, 5, 0, 0, 0, 10, 10 } },
                                                            { DWELLING_MONSTER5, Race::NECR, { 6000, 10, 0, 0, 10, 0, 0 } },
                                                            { DWELLING_UPGRADE5, Race::NECR, { 5000, 0, 0, 5, 0, 5, 0 } },
                                                            { DWELLING_MONSTER6, Race::NECR, { 14000, 15, 5, 15, 5, 5, 5 } } } };
}
...
std::string BuildingInfo::getBuildingDescription( const int race, const uint32_t buildingId )
{
    ...
    if ( isDwelling( buildingId ) ) {
        ...
        switch ( buildingId ) {
        case BUILD_CASTLE:
            StringReplace( description, "%{count}", ProfitConditions::GOLD_BY_CASTLE );
            break;
        case BUILD_MOAT:
        ...
        case BUILD_SPEC:
            if ( race == Race::WRLK )
                StringReplace( description, "%{count}", ProfitConditions::GOLD_BY_DANGEON );
            break;
        case BUILD_STATUE:
            StringReplace( description, "%{count}", ProfitConditions::GOLD_BY_STATUE );
            break;
        case BUILD_TAVERN:
            StringReplace( description, "%{count}", ProfitConditions::GOLD_BY_TAVERN );
            break;
        case BUILD_THIEVESGUILD:
            StringReplace( description, "%{count}", ProfitConditions::GOLD_BY_GUILD );
            break;
        default:
            break;
        }
