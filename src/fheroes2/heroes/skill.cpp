...
namespace
{
    constexpr std::array<int, Skill::numOfSecondarySkills> allSecondarySkills{
...
{
    return GameStatic::GetSecondarySkillValue( Skill(), Level() );
}
...
const char * Skill::Level::String( int level )
{
    ...
    case MASTER:
        return _( "skill|Master" );
    case EXPERT:
        return _( "skill|Expert" );
    case GENIUS:
        return _( "skill|Genius" );
    default:
...
{
    second = ( level >= Level::NONE && level <= MaxLevel ) ? level : Level::NONE;
}
...
{
    static const char * name_skill[] = {
        "Basic Pathfinding", "Advanced Pathfinding", "Master Pathfinding", "Expert Pathfinding", "Genius Pathfinding",
        "Basic Archery",     "Advanced Archery",     "Master Archery",     "Expert Archery",     "Genius Archery",
        "Basic Logistics",   "Advanced Logistics",   "Master Logistics",   "Expert Logistics",   "Genius Logistics",
        "Basic Scouting",    "Advanced Scouting",    "Master Scouting",    "Expert Scouting",    "Genius Scouting",
        "Basic Diplomacy",   "Advanced Diplomacy",   "Master Diplomacy",   "Expert Diplomacy",   "Genius Diplomacy",
        "Basic Navigation",  "Advanced Navigation",  "Master Navigation",  "Expert Navigation",  "Genius Navigation",
        "Basic Leadership",  "Advanced Leadership",  "Master Leadership",  "Expert Leadership",  "Genius Leadership",
        "Basic Wisdom",      "Advanced Wisdom",      "Master Wisdom",      "Expert Wisdom",      "Genius Wisdom",
        "Basic Mysticism",   "Advanced Mysticism",   "Master Mysticism",   "Expert Mysticism",   "Genius Mysticism",
        "Basic Luck",        "Advanced Luck",        "Master Luck",        "Expert Luck",        "Genius Luck",
        "Basic Ballistics",  "Advanced Ballistics",  "Master Ballistics",  "Expert Ballistics",  "Genius Ballistics",
        "Basic Eagle Eye",   "Advanced Eagle Eye",   "Master Eagle Eye",   "Expert Eagle Eye",   "Genius Eagle Eye",
        "Basic Necromancy",  "Advanced Necromancy",  "Master Necromancy",  "Expert Necromancy",  "Genius Necromancy",
        "Basic Estates",     "Advanced Estates",     "Master Estates",     "Expert Estates",     "Genius Estates"
    };

    return _( isValid() ? name_skill[( Level() - 1 ) + ( Skill() - 1 ) * MaxLevel] : "Unknown" );
}
...
std::string Skill::Secondary::GetDescription( const Heroes & hero ) const
{
    ...
    case PATHFINDING:
        ...
        case Level::EXPERT:
            ...
            break;
        case Level::GENIUS:
            str = _( "%{skill} eliminates the movement penalty for rough terrain and increases movepoints by 15%." );
            break;
        default:
            break;
        }
    ...
    case WISDOM: {
        str = _( "%{skill} increases the experience the hero gains from all sources by %{count} percent." );
        break;
    }
    case MYSTICISM: {
        str = _( "%{skill} regenerates %{count} additional spell points per day to the hero." );
        break;
    }
    case LUCK: {
    ...
    case EAGLE_EYE: {
        str = _( "%{skill} gives the hero a 100% chance to learn any given %{level} level spell that was cast by an enemy during combat and increases a founded resources by %{count}%." );
        break;
    }
    case NECROMANCY: {
                                                                                      ...
                                                                                      uint32_t const secondSkillSeed ) const
{
    ...
    result.first = levelUpSingleSkill( SecondaryPriorityFromRace( race, blacklist, firstSkillSeed ) );
