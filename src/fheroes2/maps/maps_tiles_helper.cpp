...
namespace Maps
{
    ...
    Funds getFundsFromTile( const Tile & tile, uint32_t incPercent )
    {
        switch ( tile.getMainObjectType( false ) ) {
        case MP2::OBJ_BARREL:
        case MP2::OBJ_CAMPFIRE:
        {
            ...
            auto resCount = tile.metadata()[1];
            auto goldCount = resCount * 100;
            if ( incPercent > 0 ) {
                resCount += ( resCount * incPercent + 50 ) / 100;
                goldCount += ( goldCount * incPercent + 50 ) / 100;
            }
            return Funds{ static_cast<int>( tile.metadata()[0] ), resCount } + Funds{ Resource::GOLD, goldCount };
        }

        case MP2::OBJ_FLOTSAM:
        {
            auto resCount = tile.metadata()[0];
            auto goldCount = tile.metadata()[1];
            if ( incPercent > 0 ) {
                resCount += ( resCount * incPercent + 50 ) / 100;
                goldCount += ( goldCount * incPercent + 50 ) / 100;
            }
            return Funds{ Resource::WOOD, resCount } + Funds{ Resource::GOLD, goldCount };
        }
        ...
        case MP2::OBJ_TREASURE_CHEST:
        {
            ...
            return { Resource::GOLD, goldCount };
        }
        ...
        case MP2::OBJ_RESOURCE:
        {
            ...
            return { static_cast<int>( tile.metadata()[0] ), resCount };
        }

        case MP2::OBJ_WAGON:
        {
            auto resCount = tile.metadata()[2];
            if ( incPercent > 0 ) {
                resCount += ( resCount * incPercent + 50 ) / 100;
            }
            return { static_cast<int>( tile.metadata()[1] ), resCount };
        }
    ...
    void setInitialObjectInfo( Tile & tile )
    {
        ...
        case MP2::OBJ_DAEMON_CAVE:
            // 3000 exp + 5000 gold or 1000 exp + 10000 gold or 3000 exp + art or 5000 exp
        ...
        case MP2::OBJ_TREE_OF_KNOWLEDGE:
            ...
            case 1:
                ...
                break;
            case 2:
                setResourceOnTile( tile, Resource::GOLD, 3000 );
                break;
            default:
                break;
            }
    ...
    void updateObjectInfoTile( Tile & tile )
    {
        ...
        case MP2::OBJ_WATER_WHEEL:
            ...
            setResourceOnTile( tile, Resource::GOLD, ( 0 == world.CountDay() ? 1500 : 2500 ) );
            break;
    ...
    void setMonsterOnTile( Tile & tile, const Monster & mons, const uint32_t count )
    {
        ...
        else if ( setDefinedCount || world.GetWeekInfo().IsMonsterWeek( mons.GetID() ) ) {
