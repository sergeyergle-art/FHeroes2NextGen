...
protected:
    ...
    uint32_t _remainingMovePoints{ 0 };
    uint8_t _pathfindingSkill{ Skill::MaxLevel };
};
...
public:
    ...
    uint32_t getDistance( const int start, const int targetIndex, const PlayerColor color, const double armyStrength, const uint8_t skill = Skill::MaxLevel );
