...
Skill::Secondary Dialog::selectSecondarySkill( const Heroes & hero, const int32_t skillId /* = Skill::Secondary::UNKNOWN */ )
{
    ...
    skills.reserve( static_cast<size_t>( Skill::numOfSecondarySkills ) * Skill::MaxLevel );

    for ( int i = 0; i < Skill::numOfSecondarySkills * Skill::MaxLevel; ++i ) {
