...
public:
    ...
    virtual int GetMonAttack() const;
    virtual int GetMonDefense() const;
    ...
    {
        return fheroes2::getMonBattleStats( id ).damageMin;
    }

    uint32_t GetDamageMax() const
    {
        return fheroes2::getMonBattleStats( id ).damageMax;
    }
    ...
    {
        return fheroes2::getMonBattleStats( id ).hp;
    }

    uint32_t GetExperience() const
    {
        return fheroes2::getMonBattleStats( id ).experience;
    }
    ...
    {
        return fheroes2::getMonBattleStats( id ).priority;
    }

    uint32_t GetGrown() const
    {
        return fheroes2::getMonGeneralStats( id ).baseGrowth;
    }

    uint32_t GetGrownSpeed() const
    {
        return fheroes2::getMonGeneralStats( id ).speedGrowth;
    }

    int GetMonsterLevel() const
    {
        return fheroes2::getMonGeneralStats( id ).level;
    }

    int GetBattleLevel() const
    {
        return fheroes2::getMonBattleStats( id ).level;
    }
    ...
    bool isValid() const
    {
        return id > UNKNOWN && id < RANDOM_MONSTER;
    }
    ...
    {
        return isAbilityPresent( fheroes2::MonAbil::ELEMENTAL );
    }

    bool isUndead() const
    {
        return isAbilityPresent( fheroes2::MonAbil::UNDEAD );
    }

    bool isFlying() const
    {
        return isAbilityPresent( fheroes2::MonAbil::FLYING );
    }

    bool isWide() const
    {
        return isAbilityPresent( fheroes2::MonAbil::DOUBLE_HEX_SIZE );
    }
    ...
    {
        return isAbilityPresent( fheroes2::MonAbil::HP_REGENERATION );
    }

    bool isDoubleCellAttack() const
    {
        return isAbilityPresent( fheroes2::MonAbil::TWO_CELL_MELEE_ATTACK );
    }

    bool isAllAdjacentCellsAttack() const
    {
        return isAbilityPresent( fheroes2::MonAbil::ALL_ADJACENT_MELEE_ATTACK );
    }

    bool isIgnoringRetaliation() const
    {
        return isAbilityPresent( fheroes2::MonAbil::NO_ENEMY_RETALIATION );
    }

    bool isTopMonster() const
    {
        return GetBattleLevel() > 15;
    }
    ...
    bool isAbilityPresent( const fheroes2::MonAbil abilityType ) const;

    double GetMonsterStrength() const;
    double GetMonsterStrengthWithBonus( int aBonus, int dBonus ) const;
    ...
    Funds GetCost() const
    {
        return Funds( fheroes2::getMonGeneralStats( id ).cost );
    }

    int32_t GetGoldCost() const
    {
        return fheroes2::getMonGeneralStats( id ).cost.gold;
    }
    ...
    {
        return fheroes2::getMonIcnId( id );
    }
