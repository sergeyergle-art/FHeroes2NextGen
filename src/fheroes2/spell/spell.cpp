...
namespace
{
    ...
    const std::array<SpellStats, Spell::SPELL_COUNT> spells = { {
        ...
        { gettext_noop( "Fireball" ), 10, 0, 0, 8, 30, gettext_noop( "Causes a giant fireball to strike the selected area, damaging all nearby creatures." ) },
        { gettext_noop( "Fireblast" ), 20, 0, 0, 9, 40, gettext_noop( "An improved version of fireball, fireblast affects two hexes around the center point of the spell, rather than one." ) },
        { gettext_noop( "Lightning Bolt" ), 6, 0, 0, 4, 35, gettext_noop( "Causes a bolt of electrical energy to strike the selected creature." ) },
        { gettext_noop( "Chain Lightning" ), 20, 0, 0, 5, 50, gettext_noop( "Causes a bolt of electrical energy to strike a selected creature, then strike the nearest creature with half damage, then strike the NEXT nearest creature with half again damage, and so on, until it becomes too weak to be harmful. Warning: This spell can hit your own creatures!" ) },
        { gettext_noop( "Teleport" ), 9, 0, 0, 10, 0, gettext_noop( "Teleports the creature you select to any open position on the battlefield." ) },
        { gettext_noop( "Cure" ), 4, 0, 0, 6, 10, gettext_noop( "Removes all negative spells cast upon one of your units, and restores up to %{count} HP per level of spell power." ) },
        { gettext_noop( "Mass Cure" ), 15, 0, 0, 60, 10, gettext_noop( "Removes all negative spells cast upon your forces, and restores up to %{count} HP per level of spell power, per creature." ) },
        ...
        { gettext_noop( "Holy Word" ), 10, 0, 0, 22, 15, gettext_noop( "Damages all undead in the battle." ) },
        { gettext_noop( "Holy Shout" ), 20, 0, 0, 23, 30, gettext_noop( "Damages all undead in the battle. This is an improved version of Holy Word." ) },
        ...
        { gettext_noop( "Magic Arrow" ), 4, 0, 0, 38, 25, gettext_noop( "Causes a magic arrow to strike the selected target." ) },
        ...
        { gettext_noop( "Meteor Shower" ), 20, 0, 0, 24, 60, gettext_noop( "A rain of rocks strikes an area of the battlefield, damaging all nearby creatures." ) },
        ...
        { gettext_noop( "Cold Ray" ), 5, 0, 0, 36, 30, gettext_noop( "Drains body heat from a single enemy unit." ) },
        { gettext_noop( "Cold Ring" ), 8, 0, 0, 35, 25, gettext_noop( "Drains body heat from all units surrounding the center point, but not including the center point." ) },
        { gettext_noop( "Disrupting Ray" ), 7, 0, 0, 34, 3, gettext_noop( "Reduces the defense rating of an enemy unit by three." ) },
        { gettext_noop( "Death Ripple" ), 7, 0, 0, 29, 10, gettext_noop( "Damages all living (non-undead) units in the battle." ) },
        { gettext_noop( "Death Wave" ), 17, 0, 0, 28, 25, gettext_noop( "Damages all living (non-undead) units in the battle. This spell is an improved version of Death Ripple." ) },
