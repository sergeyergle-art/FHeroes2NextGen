...
namespace
{
    ...
    const std::array<SpellStats, Spell::SPELL_COUNT> spells = { {
        ...
        { gettext_noop( "Fireball" ), 9, 0, 0, 8, 25, gettext_noop( "Causes a giant fireball to strike the selected area, damaging all nearby creatures." ) },
        { gettext_noop( "Fireblast" ), 15, 0, 0, 9, 50,
        ...
        { gettext_noop( "Chain Lightning" ), 15, 0, 0, 5, 60,
          gettext_noop(
        ...
        { gettext_noop( "Mass Cure" ), 15, 0, 0, 60, 15,
        ...
        { gettext_noop( "Resurrect" ), 12, 0, 0, 13, 60, gettext_noop( "Resurrects creatures from a damaged or dead unit until end of combat." ) },
        { gettext_noop( "Resurrect True" ), 15, 0, 0, 12, 60, gettext_noop( "Resurrects creatures from a damaged or dead unit permanently." ) },
        { gettext_noop( "Haste" ), 3, 0, 0, 14, 3, gettext_noop( "Increases the speed of any creature by %{count}." ) },
        { gettext_noop( "Mass Haste" ), 10, 0, 0, 61, 3, gettext_noop( "Increases the speed of all of your creatures by %{count}." ) },
        ...
        { gettext_noop( "Holy Word" ), 9, 0, 0, 22, 20, gettext_noop( "Damages all undead in the battle." ) },
        { gettext_noop( "Holy Shout" ), 12, 0, 0, 23, 40, gettext_noop( "Damages all undead in the battle. This is an improved version of Holy Word." ) },
        ...
        { gettext_noop( "Armageddon" ), 20, 0, 0, 16, 100, gettext_noop( "Holy terror strikes the battlefield, causing severe damage to all creatures." ) },
        { gettext_noop( "Elemental Storm" ), 15, 0, 0, 11, 75, gettext_noop( "Magical elements pour down on the battlefield, damaging all creatures." ) },
        { gettext_noop( "Meteor Shower" ), 15, 0, 0, 24, 50, gettext_noop( "A rain of rocks strikes an area of the battlefield, damaging all nearby creatures." ) },
        { gettext_noop( "Paralyze" ), 9, 0, 0, 20, 0, gettext_noop( "The targeted creatures are paralyzed, unable to move or retaliate." ) },
        { gettext_noop( "Hypnotize" ), 15, 0, 0, 37, 75,
        ...
        { gettext_noop( "Cold Ring" ), 9, 0, 0, 35, 30,
        ...
        { gettext_noop( "Death Ripple" ), 6, 0, 0, 29, 15, gettext_noop( "Damages all living (non-undead) units in the battle." ) },
        { gettext_noop( "Death Wave" ), 12, 0, 0, 28, 30,
        ...
        { gettext_noop( "Animate Dead" ), 12, 0, 0, 25, 60, gettext_noop( "Resurrects creatures from a damaged or dead undead unit permanently." ) },
        ...
        { gettext_noop( "Town Gate" ), 25, 225, 69, 48, 0,
        ...
        { gettext_noop( "Petrification" ), 10, 0, 0, 66, 50,
