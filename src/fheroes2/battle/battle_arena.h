...
namespace Battle
{
    ...
    public:
        ...
        bool IsAttacker(const Force& force) const;
        bool IsDefender(const Force& force) const;
        ...
        void UpdateSpellsInBookByBattle();
        void ResetSpellsInBookByBattle();
        void ShowAllAddedSpellsInBookByBattle();
    ...
    private:
        ...
        void applyDamageToCastleDefenseStructure( CastleFortress::TargetId target, int damage );
        ...
        std::array<std::unique_ptr<Tower>, 5> _towers;
        ...
        SpellStorage _usedSpellsByAttacker;
        SpellStorage _usedSpellsByDefender;
        std::vector<Spell> _addedSpellsToAttacker;
        std::vector<Spell> _addedSpellsToDefender;

        Board board;
        BattlePathfinder _battlePathfinder;
        int _covrIcnId{ ICN::UNKNOWN };

        CastleFortress _fortress;
