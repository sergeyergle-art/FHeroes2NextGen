...
namespace Battle
{
    ...
    public:
        ...
        int GetMonDefense() const override;
        ...
        uint32_t GetPriority( const bool skipStandingCheck, const bool skipMovedCheck ) const;
        ...
        Spell GetSpellMagic( Rand::PCG32 & randomGenerator );
