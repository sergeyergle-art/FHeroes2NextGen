...
{
    _pos.x = area.x + 89 + Board::pxOffsetX - ( ( ( _index / Board::widthInCells ) % 2 ) ? widthPx / 2 : 0 ) + widthPx * ( _index % Board::widthInCells );
    _pos.y = area.y + 62 + Board::pxOffsetY + ( ( heightPx - ( heightPx - cellHeightVerSide ) / 2 ) * ( _index / Board::widthInCells ) );
    _pos.width = widthPx;
