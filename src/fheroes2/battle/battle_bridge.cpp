...
namespace
{
    enum
    {
        CELL_GATES = Battle::CastleFortress::POS_GATE,
        CELL_MOAT = CELL_GATES - 1,
        CELL_AFTER_GATES = CELL_GATES + 1,
        CELL_BEFORE_MOAT = CELL_MOAT - 1,
        CELL_ABOVE_BRIDGE = CELL_GATES - Battle::Board::widthInCells,
        CELL_BELOW_BRIDGE = CELL_GATES + Battle::Board::widthInCells
    };
}
